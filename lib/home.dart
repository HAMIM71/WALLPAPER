...
class _HomeState extends State<Home> {
  ...
  getTrendingWallpaper() async {
    await http.get(
        /*"https://api.pexels.com/v1/collections/38naru5?per_page=$noOfImageToLoad&page=1",*/

        "https://api.pexels.com/v1/curated?per_page=$noOfImageToLoad&page=3",
        headers: {
          "Authorization": '563492ad6f917000010000019de1e97df00049088a79b87f4d6d3a73'
        }).then((value) {
      //print(value.body);
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                        child: Text(
                      "Pexels",
                      style: TextStyle(color: Colors.blue, fontSize: 12, fontFamily: 'Overpass'),
                    )),
                  )
                ],
              ),
            ...
            ? Column(
                children: <Widget>[
                  ...
                  Container(
                      ...
                      child: Text(
                        categorie,
                        style: TextStyle(color: Colors.black54, fontSize: 13, fontWeight: FontWeight.w400, fontFamily: 'Overpass'),
                      )),
                ],
              )
            : Stack(
                children: <Widget>[
                  ...
                  Container(
                      ...
                      child: Text(
                        categorie ?? "Yo Yo",
                        style: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w500, fontFamily: 'Overpass'),
                      ))
                ],
              ),
      ),
